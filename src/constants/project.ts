...
import pokemonThumb from '@/assets/projects/pokemon-thumb.png';
...
import pathfindingThumb from '@/assets/projects/pathfinding-thumb.png';
...
import kuartetThumb from '@/assets/projects/kuartet-thumb.png';
...
import tttThumb from '@/assets/projects/tic-tac-toe-thumb.png';
...
import spMockThumb from '@/assets/projects/sp-mock-thumb.png';
import spMock1Img from '@/assets/projects/sp-mock-1.png';

export const PROJECT_CV = 1;
export const PROJECT_GAME_CV = 2;
...
export const PROJECT_ASSETS = {
  ...
  ['cvc-2']: cvc2Img,
  ['cvc-3']: cvc3Img,
  ['pokemon-thumb']: pokemonThumb,
  ['pokemon-1']: pokemon1Img,
  ['pokemon-2']: pokemon2Img,
  ['pokemon-3']: pokemon3Img,
  ['pokemon-4']: pokemon4Img,
  ['pathfinding-thumb']: pathfindingThumb,
  ['pathfinding-1']: pathfinding1Img,
  ['pathfinding-2']: pathfinding2Img,
  ['pathfinding-3']: pathfinding3Img,
  ['ttt-thumb']: tttThumb,
  ['ttt-video-1']: ttt1Vid,
  ['ttt-1']: ttt1Img,
  ['ttt-2']: ttt2Img,
  ['ttt-3']: ttt3Img,
  ['ttt-4']: ttt4Img,
  ['kuartet-thumb']: kuartetThumb,
  ['kuartet-1']: kuartet1Img,
  ['kuartet-2']: kuartet2Img,
  ['kuartet-3']: kuartet3Img,
  ['sp-mock-thumb']: spMockThumb,
  ['sp-mock-1']: spMock1Img,
};
